--The degree of the Toeplitz facotrization variety \mu_2(\mathcal{T}_5)
...
w=random(kk^D,kk^1); 
RE=RM*v-w;
M= transpose RE; -- the list of generic linear equations (the number of the equations is the codimension)
...
--Result
-- used 553548s (cpu); 54364.8s (thread); 0s (gc)
-- the number of solutions is 1885, i.e., the degree is at least 1885.
